        ...
        <Row>
          <Col  xs={12} sm={12} md={7} lg={7}  
                className="d-flex justify-content-center align-items-start flex-column">
                  <p className="grade-title fs-3">Essential Free Tools for Web Developers</p>
          ...
          <p className="lead pe-5 mt-4">Unlock a curated set of free tools built for modern web developers and designers. From layout optimization and mobile simulation to screenshot sharing and UI previews. These tools help you speed up your workflow, improve your designs, and present your work professionally to clients.</p>
